...
export function AppointmentPage() {
  ...
  const availability = useQuery({ queryKey: ['appointment-slots', branchId, serviceId, date], enabled, queryFn: async () => (await apiClient.get<ApiResponse<{ slots: AppointmentSlot[]; timezone: string }>>('/appointment-availability', { params: { branch_id: branchId, service_id: serviceId, date } })).data.data })
