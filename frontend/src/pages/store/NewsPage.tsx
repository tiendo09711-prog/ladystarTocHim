...
export function NewsPage() {
  ...
  return <main className="news-page container-page">
    ...
    <header className="news-page-heading">{content?.eyebrow && <p className="news-page-kicker">{content.eyebrow}</p>}<h1>{content?.title ?? 'Tin tức'}</h1>{content?.description && <p>{content.description}</p>}</header>
