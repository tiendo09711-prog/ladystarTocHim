...
const content: Record<string, { title: string; intro: string; points: string[] }> = {
  ...
  'huong-dan-chon-toc': { title: 'Hướng dẫn chọn tóc giả nam', intro: 'Hãy bắt đầu từ vùng tóc cần che, thời gian sử dụng mỗi ngày và mức độ tự nhiên mong muốn.', points: ['Đế PU dễ vệ sinh và bám chắc', 'Đế lace thoáng, đường chân tóc tự nhiên', 'Tóc thật tạo kiểu linh hoạt', 'Chọn màu gần màu tóc thật', 'Đo kích thước vùng cần che trước khi mua'] },
