...
export function PolicyPagesAdminPage() {
  ...
  useEffect(() => setDraft(page ? structuredClone(page) : { page_key: selectedKey, title: pageOptions.find((item) => item.key === selectedKey)?.label ?? '', summary: '', content: { intro: '', sections: [] }, is_active: false, seo_title: '', seo_description: '' }), [page, selectedKey])
