...
const downloadTemplate = () => { const data: ImportRow[] = [{ name: 'Hair System mẫu', base_sku: 'LS-MAU', category: 'Hair system nam', description: 'Mô tả sản phẩm', material: 'Tóc người thật', base_type: 'Đế lace', variant_sku: 'LS-MAU-01', barcode: '8930000000001', price: 1500000, sale_price: 1350000, stock_quantity: 10, branch_code: 'MAIN', status: 'active' }]; const workbook = XLSX.utils.book_new(); XLSX.utils.book_append_sheet(workbook, XLSX.utils.json_to_sheet(data), 'products'); XLSX.writeFile(workbook, 'ladystars-import-template.xlsx') }
