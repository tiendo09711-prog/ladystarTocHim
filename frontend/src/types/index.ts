...
export interface OrderItem { id: number; product_name: string; variant_description?: string; variant_snapshot?: VariantSnapshotItem[] | null; sku: string; unit_price: number; quantity: number; line_total: number }
