    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'items' => $this->whenLoaded('items', fn () => $this->items->map(fn ($item) => [
                ...
                'original_value' => $item->original_value !== null ? (float) $item->original_value : null,
                'replacement_value' => $item->replacement_value !== null ? (float) $item->replacement_value : null,
                'price_difference' => $item->price_difference !== null ? (float) $item->price_difference : null,
