...
class AboutContent
{
    public static function sections(): array
    {
        return [
            [
                ...
                'image_alt' => 'Minh họa phong cách tóc mềm mại của LADYSTARS',
                'cta_label' => 'Khám phá sản phẩm',
                'cta_url' => '/san-pham',
                'settings' => [
                    'secondary_cta_label' => 'Nhận tư vấn riêng',
                    'secondary_cta_url' => '/lien-he',
                    'image_badge' => 'Hair system · Toupee · Personal styling',
                    'trust_items' => ['Tự nhiên trong từng chi tiết', 'Lựa chọn theo nhu cầu riêng', 'Đồng hành lâu dài'],
                ],
                'sort_order' => 1,
            ],
            [
                ...
                'image_path' => '/images/brand/ladystars-hero.svg',
                'image_alt' => 'Không gian tư vấn tinh tế của LADYSTARS',
                'settings' => [
                    'layout' => 'image-left',
                    'quote' => 'Vẻ đẹp tự nhiên không cần phải ồn ào. Nó chỉ cần vừa vặn với bạn.',
                    'floating_card' => ['title' => 'LADYSTARS', 'subtitle' => 'Personalized hair experience'],
                ],
                'sort_order' => 2,
            ],
            [
                'section_key' => 'story-empathy',
                'section_type' => 'rich_text_image',
                'eyebrow' => 'KHỞI NGUỒN',
                'title' => 'Bắt đầu từ sự lắng nghe',
                ...
                'image_path' => '/images/brand/ladystars-hero.svg',
                'image_alt' => 'Chất liệu tóc được tuyển chọn kỹ',
                'settings' => [
                    'layout' => 'image-right',
                    'pills' => ['Tự nhiên', 'Thoải mái', 'Vừa vặn'],
                ],
                'sort_order' => 3,
            ],
            [
                'section_key' => 'story-journey',
                'section_type' => 'rich_text_image',
                'eyebrow' => 'HÀNH TRÌNH',
                'title' => 'Từ một giải pháp tóc đến một trải nghiệm cá nhân hóa',
                ...
                'image_path' => '/images/brand/ladystars-hero.svg',
                'image_alt' => 'Hành trình hoàn thiện trải nghiệm tóc',
                'settings' => [
                    'layout' => 'image-left',
                    'steps' => [
                        ['label' => '01', 'title' => 'Lắng nghe'],
                        ['label' => '02', 'title' => 'Tuyển chọn'],
                        ['label' => '03', 'title' => 'Hoàn thiện'],
                    ],
                ],
                'sort_order' => 4,
            ],
            [
                ...
                'eyebrow' => 'QUY TRÌNH LADYSTARS',
                'title' => 'Cách chúng tôi tạo nên từng trải nghiệm',
            ...
            [
                ...
                'eyebrow' => 'ĐỊNH HƯỚNG',
                'title' => 'Định hướng của LADYSTARS',
                ...
                'image_path' => '/images/brand/ladystars-hero.svg',
                'image_alt' => 'Không gian trải nghiệm LADYSTARS',
                'settings' => [
                    'caption_title' => 'Designed around you',
                    'caption_subtitle' => 'Tự nhiên hơn mỗi ngày',
                    'items' => [
            ...
            [
                ...
                'section_type' => 'cards',
                'eyebrow' => 'CAM KẾT',
                'title' => 'Những điều LADYSTARS luôn giữ vững',
            ...
            [
                ...
                'title' => 'LADYSTARS muốn cùng bạn đi xa hơn',
            ...
            [
                ...
                'eyebrow' => 'ĐỘI NGŨ',
                'title' => 'Những người tạo nên trải nghiệm LADYSTARS',
            ...
            [
                ...
                'section_type' => 'cta',
                'eyebrow' => 'BẮT ĐẦU CÙNG LADYSTARS',
                'title' => 'Sẵn sàng tìm lựa chọn phù hợp với bạn?',
                ...
                'cta_label' => 'Nhận tư vấn riêng',
                'cta_url' => '/lien-he',
                'settings' => [
                    'secondary_cta_label' => 'Xem sản phẩm',
                    'secondary_cta_url' => '/san-pham',
                ],
                'sort_order' => 10,
            ],
        ];
    ...
    public static function seos(): array
    {
        return [
            ['page_key' => 'gioi-thieu', 'title' => 'Câu chuyện thương hiệu | LADYSTARS', 'description' => 'Khám phá câu chuyện, giá trị và cách LADYSTARS tạo nên trải nghiệm tóc tự nhiên, tinh tế và phù hợp với từng người.'],
            ['page_key' => 'tin-tuc', 'title' => 'Bản tin LADYSTARS', 'description' => 'Cập nhật tin tức, cẩm nang chăm sóc và câu chuyện thương hiệu từ LADYSTARS.'],
        ];
    }
}
